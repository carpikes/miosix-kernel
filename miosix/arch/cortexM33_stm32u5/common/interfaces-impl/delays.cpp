...
void delayMs(unsigned int mseconds)
{
    ...
    register const unsigned int count=40000-1;
    #elif SYSCLK_FREQ_110MHz
    register const unsigned int count=27500-1;
    #elif SYSCLK_FREQ_48MHz
    register const unsigned int count=12000-1;
    #elif SYSCLK_FREQ_24MHz
    register const unsigned int count=6000-1;
    #else
